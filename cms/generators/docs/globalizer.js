{
	...
	abstracted_content: {
		...
		contents: [
			...
			{
				heading: 'Non-recursive link',
				level: '2',
				link: 'non-recursive-link'
			},
			{
				heading: 'Limitations',
				level: '2',
